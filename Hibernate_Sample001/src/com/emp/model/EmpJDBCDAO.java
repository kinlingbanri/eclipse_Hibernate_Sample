...
public class EmpJDBCDAO implements EmpDAO_interface {
	...
	String userid = "scott";
	String passwd = "Tandy680927";

	private static final String INSERT_STMT = 
		"INSERT INTO emp (empno,ename,job,hiredate,sal,comm,deptno) VALUES (emp_seq.NEXTVAL, ?, ?, ?, ?, ?, ?)";
	private static final String GET_ALL_STMT = 
		"SELECT empno,ename,job,to_char(hiredate,'yyyy-mm-dd') hiredate,sal,comm,deptno FROM emp order by empno";
	private static final String GET_ONE_STMT = 
		"SELECT empno,ename,job,to_char(hiredate,'yyyy-mm-dd') hiredate,sal,comm,deptno FROM emp where empno = ?";
	...
	public static void main(String[] args) {
		...
		// 查詢
		EmpVO empVO3 = dao.findByPrimaryKey(7003);
